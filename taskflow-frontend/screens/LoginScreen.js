...
export default function LoginScreen({ onNavigateToRegister, onLoginSuccess }) {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // Al autenticar con éxito:
            await AsyncStorage.setItem('user', JSON.stringify(usuarioRespuesta));

            // Si la llamada fue exitosa, notificamos al padre pasando el usuario completo
            if (onLoginSuccess) {
...
export default function LoginScreen({ onNavigateToRegister, onLoginSuccess }) {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // Pasa el usuario al componente padre (App.js) solo en memoria sin guardarlo localmente
            if (onLoginSuccess) {
                onLoginSuccess(usuarioRespuesta);
            }
        } catch (error) {
